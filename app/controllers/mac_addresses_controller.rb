...
class MacAddressesController < ApplicationController
  ...
  def index
    ...
    @mac_addresses = @mac_addresses.sort {|a, b| IPAddr.new((a.ipv4_addr.nil? || a.ipv4_addr.empty?) ? "255.255.255.255" : a.ipv4_addr) <=> IPAddr.new((b.ipv4_addr.nil? || b.ipv4_addr.empty?) ? "255.255.255.255" : b.ipv4_addr)}
